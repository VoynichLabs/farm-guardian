...
- **Instagram posting to `@pawel_and_pawleen`** — full operational runbook at **`~/bubba-workspace/skills/farm-instagram-post/SKILL.md`**. Two plan docs in this repo:
  ...
  - **`docs/20-Apr-2026-ig-poster-implementation-plan.md`** — V2.0 code implementation plan: `tools/pipeline/ig_poster.py` + `hashtags.yml` + `git_helper.py` + `scripts/ig-post.py` CLI + DB migration + orchestrator hook. Phased 1–8; Phase 1 (hashtags.yml) is shipped as of 2026-04-20. Phases 2+ pending.
