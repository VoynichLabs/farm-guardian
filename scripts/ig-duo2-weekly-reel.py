...
# Date: 03-Aug-2026
# PURPOSE: LaunchAgent entry point for the duo2 WEEKLY daylight panoramic
...
from tools.pipeline.daily_reel_runner import DUO2_WEEKLY_TIMELAPSE_LANE, main  # noqa: E402


if __name__ == "__main__":
    sys.exit(main(DUO2_WEEKLY_TIMELAPSE_LANE))
