...
**Last verified end-to-end:** 2026-04-14 21:44 ET (Claude Opus 4.6 — v2.27.0, `usb-cam` moved back to the Mac Mini, `usb-cam-host` refactored to continuous-capture architecture → /photo.jpg latency 3.4 s → 75 ms)
