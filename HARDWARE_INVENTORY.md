...
**Last verified end-to-end:** 2026-04-30 ET (Claude Sonnet 4.6 — v2.38.5 — `mba-cam` recommissioned as optional brooder monitor; `usb-cam` now on GWTC at 192.168.0.68:8089; `s7-cam` moved to nesting box; `gwtc` moved to roof of coop; fleet is five cameras: four always-on + MBA when brooder monitoring is needed)
